...
# adme_mdr1 dataset experiments with molclr_gcn
# Dataset: adme_mdr1 (ADME, regression)
# Splits: scaffold, butina, umap, time
# Epochs: 501

python src/run.py --config configs/molclr_gcn.yaml --dataset adme_mdr1 --split scaffold --epochs 501 &
python src/run.py --config configs/molclr_gcn.yaml --dataset adme_mdr1 --split butina --epochs 501 &
