...
# adme_hppb dataset experiments with molclr_gcn
# Dataset: adme_hppb (ADME, regression)
# Splits: scaffold, butina, umap, time
# Epochs: 501

python src/run.py --config configs/molclr_gcn.yaml --dataset adme_hppb --split scaffold --epochs 501 &
python src/run.py --config configs/molclr_gcn.yaml --dataset adme_hppb --split butina --epochs 501 &
