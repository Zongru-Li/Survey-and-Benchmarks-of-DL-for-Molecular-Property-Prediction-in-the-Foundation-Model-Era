...
# adme_rlm dataset experiments with mol_gdl
# Dataset: adme_rlm (ADME, regression)
# Splits: scaffold, butina, umap, time
# Epochs: 501

python src/run.py --config configs/mol_gdl.yaml --dataset adme_rlm --split scaffold --epochs 501 &
python src/run.py --config configs/mol_gdl.yaml --dataset adme_rlm --split butina --epochs 501 &
