...
# adme_rlm dataset experiments with molclr_gin
# Dataset: adme_rlm (ADME, regression)
# Splits: scaffold, butina, umap, time
# Epochs: 501

python src/run.py --config configs/molclr_gin.yaml --dataset adme_rlm --split scaffold --epochs 501 &
python src/run.py --config configs/molclr_gin.yaml --dataset adme_rlm --split butina --epochs 501 &
