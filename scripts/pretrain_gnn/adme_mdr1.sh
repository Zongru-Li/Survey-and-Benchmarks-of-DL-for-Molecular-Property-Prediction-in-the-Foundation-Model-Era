...
# adme_mdr1 dataset experiments with pretrain_gnn
# Dataset: adme_mdr1 (ADME, regression)
# Splits: scaffold, butina, umap, time
# Epochs: 501

python src/run.py --config configs/pretrain_gnn.yaml --dataset adme_mdr1 --split scaffold --epochs 501 &
python src/run.py --config configs/pretrain_gnn.yaml --dataset adme_mdr1 --split butina --epochs 501 &
